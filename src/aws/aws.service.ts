...
export class AwsService {
    ...
    async uploadFileToS3({ s3Bucket, file, folder, fileName, ACL = ObjectCannedACL.private }: { s3Bucket: string; file: Express.Multer.File; folder: string; fileName?: string; ACL?: ObjectCannedACL }) {
